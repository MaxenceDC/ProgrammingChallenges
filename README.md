...
| 054 - Bonus   | Include .gif support for the Basic Steganography      |     🟥     |    ❌    |
...
| 082           | Interpreted LISP-Like Programming Language            |     🟨     |    ❌    |
| 083           | Application capable of mounting Filesystems (FUSE)    |     🟥     |    ❌    |
| 084           | UART Game in Assembly                                 |     🟨     |    ❌    |
| 085           | Colored Pong Game as a UEFI file                      |     🟥     |    ❌    |
| 086           | Designing an Esoteric Language                        |     🟥     |    ❌    |
| 087           | C Compiler                                            |     🟥     |    ❌    |
| 088           | Turing Machine Simulator                              |     🟥     |    ❌    |
| 089           | Read, Evaluate, Print Loop using a compiled language  |     🟥     |    ❌    |
| 090           | Static Website Generator (Template to HTML & CSS)     |     🟨     |    ❌    |
| 091           | Chirp-8 Emulator                                      |     🟨     |    ❌    |
| 091 - Bonus 1 | Chirp-8 Emulator with Cached Interpreter              |     🟥     |    ❌    |
| 091 - Bonus 2 | Chirp-8 Emulator with Dynamic Recompiler              |     🟥     |    ❌    |
| 092           | Double Pendulum Simulation                            |     🟨     |    ❌    |
| 093           | Constructive Solid Geometry                           |     🟨     |    ❌    |
| 094           | Ray Tracer                                            |     🟥     |    ❌    |
...
| 104           | Knight's Tour                                         |     🟨     |    ❌    |
| 105           | Monster Raising and/or Breeding Simulator             |     🟥     |    ❌    |
| 106           | Tetris                                                |     🟨     |    ❌    |
| 107           | Snake                                                 |     🟩     |    ❌    |
| 108           | Pipe Dreams                                           |     🟨     |    ❌    |
| 109           | Pac Man, with Different Behaviors for each Ghosts     |     🟨     |    ❌    |
| 110           | Dragon Quest (Basic RPG Engine)                       |     🟥     |    ❌    |
| 111           | Rock Paper Scissors                                   |     🟩     |    ❌    |
| 112           | First-Person Engine in OpenGL                         |     🟥     |    ❌    |
| 112 - Bonus   | First-Person Engine in OpenGL, with VR support        |     ​🟪     |    ❌    |
| 113           | Shuffle a Deck of Cards, with visuals                 |     🟨     |    ❌    |
| 114           | Simulation of a Game of Tag (with Multi-Agent System) |     🟨     |    ❌    |
| 115           | Wolfenstein Clone (FPS, 2D that appears to be 3D)     |     🟥     |    ❌    |
| 116           | Scorched Earth Clone                                  |     🟨     |    ❌    |
| 117           | Minesweeper Clone                                     |     🟨     |    ❌    |
| 118           | Audio/Visual 64Kb Demonstration                       |     🟨     |    ❌    |
| 119           | Sudoku                                                |     🟨     |    ❌    |
| 120           | Danmaku (Bullet Hell) Engine                          |     🟥     |    ❌    |
| 121           | Roguelike Engine (Dungeon Generator)                  |     🟥     |    ❌    |
| 122           | Game Engine in Unity                                  |     🟩     |    ❌    |
| 123           | Yahtzee                                               |     🟩     |    ❌    |
| 124           | Oil Panic                                             |     🟩     |    ❌    |
| 125           | Chess                                                 |     🟨     |    ❌    |
| 126           | Go (no AI)                                            |     🟥     |    ❌    |
...
| 134           | Ulam Spiral                                           |     🟩     |    ❌    |
| 135           | Bellman-Ford Simulation (at least 5 Vertices)         |     🟨     |    ❌    |
| 136           | Matrix Arithmetic                                     |     🟨     |    ❌    |
| 137           | File Compression Utility                              |     🟨     |    ❌    |
| 138           | PDF Tagger                                            |     🟩     |    ❌    |
| 139           | Nonogram Generator & Solver                           |     🟥     |    ❌    |
| 140           | Calculate Dot & Cross Product of 2 Vectors            |     🟨     |    ❌    |
| 141           | Bismuth Fractal                                       |     🟨     |    ❌    |
| 142           | Seam Carving                                          |     🟨     |    ❌    |
| 143           | Bayesian Filter                                       |     🟨     |    ❌    |
| 144           | WMS Viewer (not Web-Based)                            |     🟥     |    ❌    |
